...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?= base_url(); ?>index2.html" class="logo">
      ...
      <span class="logo-lg"><b>SKP</b> Online</span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="<?= base_url(); ?>backend" class="dropdown-toggle" data-toggle="dropdown">
            ...
            <ul class="dropdown-menu">
              ...
              <li class="user-header">
                ...
                <p>
                  STMIK Yadika Bangil - Web Developer
                  <small>Team KKN . 2K18</small>
                </p>
              </li>
              <!-- Menu Body -->
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="<?php if($title=='Dashboard') { echo "active"; } ?>"><a href="<?= base_url('backend/index'); ?>">

          <i class="fa fa-dashboard"></i> <span>Dashboard</span>
          </a>
          <li class="<?php if(($title=='Jabatan')
                          OR ($title=='Pegawai')
                          OR ($title=='Periode')
                          OR ($title=='Palru')
                          OR ($title=='Perilaku')
                          OR ($title=='Lembaga')) { echo "active"; } ?> treeview">
          <a href="<?= base_url(); ?>#">
          ...
          <ul class="treeview-menu">
            <li class="<?php if($title=='Jabatan') { echo "active"; } ?>"><a href="<?= base_url("backend/jabatan"); ?>">
              <i class="fa fa-circle-o text-aqua"></i> Jabatan</a></li>
            <li class="<?php if($title=='Pegawai') { echo "active"; } ?>"><a href="<?= base_url("backend/pegawai"); ?>">
              <i class="fa fa-circle-o text-yellow"></i> Pegawai</a></li>
            <li class="<?php if($title=='Periode') { echo "active"; } ?>"><a href="<?= base_url("backend/periode"); ?>"><i class="fa fa-circle-o text-aqua"></i> Periode</a></li>
            <li class="<?php if($title=='Palru') { echo "active"; } ?>"><a href="<?= base_url("backend/palru"); ?>"><i class="fa fa-circle-o text-yellow"></i> Pangkat</a></li>
            <li class="<?php if($title=='Perilaku') { echo "active"; } ?>"><a href="<?= base_url("backend/perilaku"); ?>"><i class="fa fa-circle-o text-aqua"></i> Perilaku</a></li>
            <li class="<?php if($title=='Lembaga') { echo "active"; } ?>"><a href="<?= base_url("backend/lembaga"); ?>"><i class="fa fa-circle-o text-yellow"></i> Lembaga</a></li>
          </ul>
        </li>
        <li class="<?php if(($title=='Laporan Jabatan')
                          OR ($title=='Laporan Pegawai')
                          OR ($title=='Laporan Periode')
                          OR ($title=='Laporan Palru')
                          OR ($title=='Laporan Perilaku')
                          OR ($title=='Laporan Lembaga')) { echo "active"; } ?> treeview">
          <a href="<?= base_url(); ?>#">
          ...
          <ul class="treeview-menu">
            <li class="<?php if($title=='Laporan Jabatan') { echo "active"; } ?>"><a href="<?= base_url("backend/laporan_jabatan"); ?>"><i class="fa fa-circle-o"></i> Laporan Jabatan</a></li>
            <li class="<?php if($title=='Laporan Pegawai') { echo "active"; } ?>"><a href="<?= base_url("backend/laporan_pegawai"); ?>"><i class="fa fa-circle-o"></i> Laporan Pegawai</a></li>
            <li class="<?php if($title=='Laporan Periode') { echo "active"; } ?>"><a href="<?= base_url("backend/laporan_periode"); ?>"><i class="fa fa-circle-o"></i> Laporan Periode</a></li>
            <li class="<?php if($title=='Laporan Palru') { echo "active"; } ?>"><a href="<?= base_url("backend/laporan_palru"); ?>"><i class="fa fa-circle-o"></i> Laporan Pangkat</a></li>
            <li class="<?php if($title=='Laporan Perilaku') { echo "active"; } ?>"><a href="<?= base_url("backend/laporan_Perilaku"); ?>"><i class="fa fa-circle-o"></i> Laporan Perilaku</a></li>
            <li class="<?php if($title=='Laporan Lembaga') { echo "active"; } ?>"><a href="<?= base_url("backend/laporan_lembaga"); ?>"><i class="fa fa-circle-o"></i> Laporan Lembaga</a></li>
          </ul>
        </li>
      </ul>
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; TimKKN2K18 <a href="<?= base_url(); ?>http://stmik-yadika.ac.id/">2018</a>.</strong> In Progress Repair.
  </footer>
  </div>
  <!-- ./wrapper -->
